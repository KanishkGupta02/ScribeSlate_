    ...
    return (
        <>
            ...
            {!translating && (<div className='flex flex-col gap-1 mb-4'>
                <p className='text-xs sm:text-sm font-semibold text-slate-600 mr-auto'>To language</p>
                <div className='flex items-stretch gap-2 sm:gap-4 font-semibold' >
                    ...
                    <button onClick={generateTranslation} className='specialBtn px-3 py-2 rounded-lg text-purple-400 hover:text-purple-600 duration-200 font-semibold'>
                        Translate
                    </button>
                </div>
            </div>)}
